...
**Initiation:** Defined the project charter and secured approvals from key stakeholders including the COO, CTO, MSME business head, and Engineering leadership. Identified key success metrics (cost savings, TAT improvements, and adoption rates). Conducted stakeholder analysis and drafted the initial business case and benefit realization plan.   **Planning:** Developed a high-level project roadmap and managed product backlog creation in collaboration with the Product Manager. Facilitated sprint planning and backlog grooming sessions. Defined project scope, cost baseline, and resource plan. Created a risk register and mitigation strategies for regulatory compliance, third-party integrations, and data migration. Developed stakeholder engagement and communication management plans.    
